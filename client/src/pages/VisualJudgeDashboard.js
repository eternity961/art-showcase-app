...
function VisualJudgeDashboard() {
  const category = 'visual';
    ...
    <Box sx={{ display: 'flex' }}>
      {!isMobile && (
        ...
        >
          ...
          {['all', 'evaluated', 'unevaluated'].map(status => (
            <Link
              key={status}
              ...
              sx={{
                ...
                color: filterStatus === status ? '#fff' : 'inherit',
                mb: 1,
...
export default VisualJudgeDashboard;
